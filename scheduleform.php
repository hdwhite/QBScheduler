...
<div class="entry">
	...
	<p><b>This tool is still in development.</b> I hope no bugs made it to production, but if you find anything wrong, please contact me so I can work on fixing it.</p><br>
	<p>I am continually in the process of adding more schedule formats. Ideally I would like to have options for high school tournaments up to 36 teams and college tournaments up to 24 teams at least.</p><br>
...
<div class="entry">
	<form action="/test/QBScheduler/createschedule.php" method="post">
		...
		<div id="rrfinals" class="roomblock finalsformat" style="display:none;">
			...
			<input type="radio" name="finals" class="finals" id="1" value="1">1 (Run a finals match only if the top two teams have equal records.)<br>
			<input type="radio" name="finals" class="finals" id="2" value="2">2 (The above, plus advantaged finals if the top two teams are separated by one game.)<br>
			<input type="radio" name="finals" class="finals" id="3" value="3">3 (The above, plus play-in matches if there is a tie for second place.)<br>
		</div>
		<div id="crossfinals" class="roomblock finalsformat" style="display:none;">
			<br><p><b>Number of finals matches:</b></p>
			<input type="radio" name="finals" class="finals" id="1" value="1">1 (The top team from each of the two top brackets play in a one-game finals.)<br>
			<input type="radio" name="finals" class="finals" id="2" value="2">2 (The top two teams from each of the top two brackets play in a 4-team elimination bracket.)<br>
		</div>
