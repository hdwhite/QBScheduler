...
<div class="scontainer">
	...
	<div class="instruction">
		<p>Teams will be initially seeded into 4 brackets of 8, in which they will play a seven-game round-robin. The top two teams within each bracket will be placed into two four-team brackets, each of which contains two top finishers and two second-place finishers. The remaining 24 teams will be placed into five brackets, each of which contains teams that finished in the same position in the preliminary rounds.</p>
