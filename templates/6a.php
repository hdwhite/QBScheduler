<div class="scontainer">
	...
	<div class="phase">
		...
		<div class="schedule center">
			<table>
				<thead>
					<tr><th>Round</th><th class="room0"><?php echo($roomlist[0]); ?></th><th class="room1"><?php echo($roomlist[1]); ?></th><th class="room2"><?php echo($roomlist[2]); ?></th></tr>
				</thead>
				<tbody>
				<?php
					...
					foreach($teamorder as $round => $roundorder)
					{
						...
						for($j = 0; $j < sizeof($roundorder); $j += 2)
	...
	<div class="instruction">
		<p>Teams will play every other team twice, for a ten-game double round-robin. After the final game, the champion will be detrmined as follows:</p>
		<ul>
