				...
				<table>
					...
					<?php
						foreach($teamorder as $round => $roundorder)
						{
							...
							echo("<td><span class='team" . (end($roundorder) + 15) . "'></span>&nbsp;</td>");
							echo("</tr>\n");
						}
					?>
					</tbody>
				...
				<table>
					...
					<?php
						...
						foreach($teamorder as $round => $roundorder)
						{
							echo("<tr><th>" . ($round + 8) . "</th>");
							for($j = 0; $j < 6; $j += 2)
								echo("<td><span class='playoffteam" . ($roundorder[$j] + 15) . "'></span>&nbsp;<br><span class='playoffteam" . ($roundorder[$j+1] + 15) . "'></span>&nbsp;</td>");
							if($round < 4)
								echo("<td><span class='playoffteam" . (end($roundorder) + 15) . "'></span>&nbsp;</td></tr>\n");
							else
								echo("<td><span class='playoffteam" . ($roundorder[6] + 15) . "'></span>&nbsp;<br><span class='playoffteam" . ($roundorder[7] + 15) . "'></span>&nbsp;<br><span class='playoffteam" . ($roundorder[8] + 15) . "'></span>&nbsp;</td></tr>\n");
						}
					?>
					</tbody>
				</table>
