	...
	<div class="phase">
		...
		<div class="phaserow">
			<div class="schedule center">
				<table>
					<thead>
						<tr><th>Round</th><th class="room4"></th><th class="room5"></th><th class="room6"></th><th class="room3"></th><th>Bye</th></tr>
					</thead>
					<tbody>
					<?php
		...
		<div class="phaserow">
			<div class="schedule center">
				<table>
					<thead>
						<tr><th>Round</th><th class="room7"></th><th class="room8"></th><th class="room9"></th><th class="room10"></th></tr>
					</thead>
					<tbody>
					<?php
						$teamorder = array(array(6, 7, 2, 3, 4, 5, 99, 99, 0, 1),
	...
	<div class="phase">
		...
		<div class="phaserow">
			<div class="schedule center">
				<table>
					<thead>
						<tr><th>Round</th><th class="room6"></th><th class="room7"></th><th class="room8"></th></tr>
					</thead>
					<tbody>
					<?php
						foreach($teamorder as $round => $roundorder)
		...
		<div class="phaserow">
			<div class="schedule center">
				<table>
					<thead>
						<tr><th>Round</th><th class="room9"></th><th class="room10"></th><th class="room11"></th></tr>
					</thead>
					<tbody>
					<?php
						foreach($teamorder as $round => $roundorder)
						{
							echo("<tr><th>" . ($round + 9) . "</th>");
							for($j = 0; $j < sizeof($roundorder) - 1; $j += 2)
								echo("<td><span class='playoffteam" . ($roundorder[$j] + 18) . "'></span>&nbsp;<br><span class='playoffteam" . ($roundorder[$j+1] + 18) . "'></span>&nbsp;</td>");
							// echo("<td><span class='playoffteam" . end($roundorder) . "'></span>&nbsp;</td></tr>\n");
						}
					?>
					</tbody>
