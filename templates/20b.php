...
<div class="scontainer">
	...
	<div class="instruction">
		<p>Teams will be initially seeded into two brackets of 10, in which they will play a nine-game round-robin. Afterwards, the teams will be placed into two playoff brackets of 10 based on their performance in the preliminary rounds. Each team will once again play a round-robin within their new bracket, with the exception of the teams they played in the prelims. Only games played against teams in the same playoff bracket will count towards final standing within each bracket. Finals in the top bracket will be played according to the following criteria:</p>
		<ul>
