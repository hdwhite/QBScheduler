<div class="scontainer">
	...
	<div class="instruction">
		<p>Teams will be initially seeded into two brackets of 6, in which they will play a five-game round-robin. Afterwards, the teams will be placed into two playoff brackets of 6 based on their performance in the preliminary rounds. Each team will once again play a full round-robin within their new bracket. Only the five playoff games played will count towards final standing within each bracket. Finals in the top bracket will be played according to the following criteria:</p>
		<ul>
		...
		<div class="phaserow">
			<div class="schedule center">
				<table>
					...
					<tbody>
					<?php
						$teamorder = array(array(1, 3, 0, 5, 2, 4),
										   array(4, 5, 2, 3, 0, 1),
										   array(0, 2, 1, 5, 3, 4),
										   array(1, 2, 3, 5, 0, 4),
										   array(0, 3, 1, 4, 2, 5));
