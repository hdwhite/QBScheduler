	...
	<div class="phase">
		...
		<div class="phaserow">
			<div class="schedule center narrow">
				<table>
					<thead>
						<tr><th>Round</th><th class="room5"></th><th class="room6"></th><th class="room7"></th><th class="room8"></th><th class="room9"></th><th>Bye</th></tr>
					</thead>
					<tbody>
					<?php
						foreach($teamorder as $round => $roundorder)
